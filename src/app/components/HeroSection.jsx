    ...
    <section className="relative py-12 lg:py-24">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
          ...
          >
            <h1 className="text-white text-4xl sm:text-5xl lg:text-7xl xl:text-8xl font-extrabold leading-tight">
            ...
            <div className="flex flex-col lg:flex-row items-center gap-4">
              <Link
                href="/#contact"
                className="px-6 py-3 rounded-full bg-gradient-to-br from-blue-500 to-teal-500 text-white font-semibold hover:bg-gradient-to-bl transition-colors duration-300"
              >
                Contactame
              </Link>
            </div>
          ...
          >
            <div className="relative w-64 h-64 lg:w-80 lg:h-80 rounded-full bg-[#1a1a1a] shadow-xl">
              <Image
